...
HRESULT CTerrain::Initialize(void * pArg)
{
	...
	//m_pTransformCom->Set_State(CTransform::STATE_TRANSLATION, XMVectorSet(-52.395f, 0.f, -34.741f, 1.f));
...
HRESULT CTerrain::SetUp_ShaderResources()
{
	...
	if (FAILED(m_pTextureCom[TYPE_FILTER]->Bind_ShaderResource(m_pShaderCom, "g_FilterTexture", 0)))
		return E_FAIL;
	//if (FAILED(m_pTextureCom[TYPE_PICKING]->Bind_ShaderResources(m_pShaderCom, "g_PickingTexture")))
	//	return E_FAIL;
