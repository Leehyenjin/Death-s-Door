...
HRESULT CEffect::Initialize(void * pArg)
{
	...
	if (FAILED(SetUp_Compponents()))
		return E_FAIL;

	//m_pTransformCom->Set_tState(CTransform::STATE_TRANSLATION, XMVectorSet(rand() % 10, 3.f, rand() % 10, 1.f));
...
HRESULT CEffect::SetUp_Compponents()
{
	// For.Com_Renderer
	if (FAILED(__super::Add_Component(CGameInstance::Get_StaticLevelIndex(), TEXT("Prototyep_Component_Renderer"), TEXT("Com_Renderer"),
