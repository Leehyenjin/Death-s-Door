...
HRESULT CRenderer::Draw_RenderGroup()
{
	...
	// 셰이드 타겟을 바인딩 하고, 셰이드 타겟에다가 명암을 그릴수 있도록 처리를 한다
	// 명암을 그리기위해서는 빛의 정보와 노멀의 정보가 필요하다
	// 노멀벡터의 경우 노멀 렌더타겟으로부터 얻어온다 빛의 정보의 경우 라이트객체로부터 얻어온다
	// 셰이드타겟을 가득 채우고 그려줄 수 있는 정점버퍼를 그린다. 이용하는 셰이더에게 노멀타켓과 빛 정보를 전역변수로 던져서 연산 할 수 있도록 하겠다
...
HRESULT CRenderer::Initialize_Prototype()
{
	...
	// For.MRT_Deferred		디퍼드 랜더링(빛)을 수행하기위해 필요한 데이터들을 저장한 랜더타켓들
	...
	// For.MRT_LightAcc		빛 연산의 결과를 저장할 랜더타겟들
