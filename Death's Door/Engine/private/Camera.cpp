...
HRESULT CCamera::Initialize(void * pArg)
{
	...
	m_pPipeLine->Set_Transform(CPipeLine::D3DTS_PROJ, XMMatrixPerspectiveFovLH(m_CameraDesc.FOV, m_CameraDesc.Aspect, m_CameraDesc.NearZ, m_CameraDesc.FarZ));
...
_uint CCamera::Tick(_double TimeDelta)
{
	...
	m_pPipeLine->Set_Transform(CPipeLine::D3DTS_VIEW, m_pTransformCom->Get_WorldMatrix_Inverse());
	m_pPipeLine->Set_Transform(CPipeLine::D3DTS_PROJ, XMMatrixPerspectiveFovLH(XMConvertToRadians(60.0f), 1024 / (_float)600, 0.2f, 300.f));
