...
void CTransform::tScaled(STATE eState, _float fScale)
{
...
void CTransform::tScaled(_float3 vScale)
{
...
void CTransform::tScaling(STATE eState, _float fScale)
{
	if (eState == STATE_TRANSLATION)
		return;
...
CTransform & CTransform::Set_Scaled(_float3 vScale)
{
...
CTransform & CTransform::Set_Scaling(_float3 vScale)
{
	_vector vRight = Get_tState(CTransform::STATE_RIGHT);
	_vector vUp = Get_tState(CTransform::STATE_UP);
	_vector vLook = Get_tState(CTransform::STATE_LOOK);
...
void CTransform::Set_Angle(_double RadianX, _double RadianY, _double RadianZ)
{
	_matrix matRotation = XMMatrixRotationX((_float)RadianX)
		*XMMatrixRotationY((_float)RadianY)
		*XMMatrixRotationZ((_float)RadianZ);
